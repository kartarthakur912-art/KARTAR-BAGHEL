...
const Brokers: React.FC = () => {
  ...
  return (
    <section className="py-16 md:py-28 bg-[#050505] relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="relative">
          <div className="flex overflow-x-auto gap-5 md:gap-8 pb-10 px-6 md:px-12 hide-scrollbar snap-x snap-mandatory">
            {partners.map((broker, idx) => (
              <div 
                key={idx}
                className={`flex-none w-[280px] md:w-[380px] snap-center relative group bg-[#0A0A0A] border-l-4 ${broker.color} p-6 md:p-10 rounded-r-3xl rounded-l-lg transition-all duration-500 hover:bg-[#0D0D0D] overflow-hidden shadow-2xl`}
              >
                ...
                <div className="relative z-10">
                  <div className="flex justify-between items-start mb-6">
                    <div className="flex flex-col">
                      ...
                      <h3 className="text-2xl md:text-3xl font-black text-white tracking-tighter uppercase">{broker.name}</h3>
                    </div>
                  ...
                  <p className="text-gray-400 text-xs md:text-sm mb-6 leading-relaxed font-medium italic min-h-[40px]">
                    "{broker.description}"
                  </p>
          ...
          <div className="flex flex-col items-center gap-3">
            <p className="text-gray-600 text-[9px] uppercase tracking-[0.3em] font-bold animate-pulse">
              ← Swipe for Elite Brokers →
            </p>
            <div className="w-24 h-0.5 bg-yellow-600/10 rounded-full overflow-hidden">
               <div className="w-1/3 h-full bg-yellow-500/50"></div>
            </div>
          </div>
        </div>

        <div className="mt-12 md:mt-20 glass p-6 md:p-8 mx-6 rounded-[30px] border-yellow-500/10 text-center">
