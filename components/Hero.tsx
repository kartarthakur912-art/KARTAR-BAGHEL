...
const Hero: React.FC = () => {
  ...
  return (
    <section className="min-h-[90vh] flex flex-col items-center justify-center px-6 text-center relative overflow-hidden pt-8 md:pt-10">
      ...
      <h1 className="text-4xl md:text-8xl font-black tracking-tighter uppercase leading-[0.9] md:leading-[0.85] mb-4 md:mb-6">
        INSTITUTIONAL <br /><span className="gold-gradient">ALGORITHM</span>
      </h1>
